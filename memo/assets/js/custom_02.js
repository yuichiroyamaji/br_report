$(function(){
    ...
    $('#add_staff').click(function(){
        ...
        contents = contents + '<option>美咲</option><option>イリヤ</option><option>カナ</option><option>柘榴</option><option>カーマ</option><option>ののか</option><option>ヒメ</option><option>弓月</option>';
